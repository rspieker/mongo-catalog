...
const data: CoverageData = JSON.parse(
    readFileSync(join(__dirname, '../../../automation/coverage/project.json'), 'utf-8')
)

export type ProjectDocument = MongoDocument<Record<string, unknown>>

export const project: Catalog<ProjectDocument> = {
    operations: [
