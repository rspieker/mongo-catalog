...
const data: CoverageData = JSON.parse(
    readFileSync(join(__dirname, '../../../automation/coverage/or.json'), 'utf-8')
)

export type OrDocument = MongoDocument<Record<string, unknown>>

export const coverage_or: Catalog<OrDocument> = {
    operations: [
