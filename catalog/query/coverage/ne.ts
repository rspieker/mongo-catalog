...
const data: CoverageData = JSON.parse(
    readFileSync(join(__dirname, '../../../automation/coverage/ne.json'), 'utf-8')
)

export type NeDocument = MongoDocument<Record<string, unknown>>

export const coverage_ne: Catalog<NeDocument> = {
    operations: [
