...
const data: CoverageData = JSON.parse(
    readFileSync(join(__dirname, '../../../automation/coverage/all.json'), 'utf-8')
)

export type AllDocument = MongoDocument<Record<string, unknown>>

export const coverage_all: Catalog<AllDocument> = {
    operations: [
